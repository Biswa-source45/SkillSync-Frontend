...
const MotionHighlight = ({ items, hover = true }) => {
  ...
  return (
    <div
      ...
      className="relative w-full max-w-6xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 p-6  bg-gradient-to-b from-neutral-800  to-black rounded-2xl overflow-hidden "
    >
      <AnimatePresence>
        {highlight && (
          <motion.div
      ...
      {items.map((item, idx) => (
        <div
          ...
          className="relative z-10 p-5 rounded-xl bg-neutral-800/30 backdrop-blur-md transition-colors duration-300 cursor-pointer hover:bg-neutral-700/30 border-gray-950"
        >
